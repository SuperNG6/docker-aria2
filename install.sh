...
# 固定到 Aria2-Pro-Core ci-20260524-090242-UTC（x86-64-v2 编译，兼容老 CPU 如 Apollolake）
...
URL="https://github.com/SuperNG6/Aria2-Pro-Core/releases/download/ci-20260524-090242-UTC/${ASSET}"
